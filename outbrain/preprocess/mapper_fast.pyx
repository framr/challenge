...
__all__ = ["Join", "ProcessGeoData", "ProcessTimestamp", "CountAdsInBlock", "ProcessMissing", "ComputeStatFactors",
           "ComputeRelCTR"]
def export(func):
...
class ComputeRelCTR(Mapper):
    ...
    def __init__(self, ctr0=0.2):
        ...
        #XXX: hardcoding
        stat_keys = [
            ("document_id_ad_id", "document_id"),
            ("document_id_campaign_id", "document_id"),
            ("source_id_ad_id", "source_id"),
            ("source_id_campaign_id", "source_id")
        ]
        self._stat_keys = stat_keys
